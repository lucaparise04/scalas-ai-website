...
export default function ServicesOverview() {
  ...
  return (
    <section className="relative py-20 lg:py-32 overflow-hidden section-gradient-2 glow-line-top">
      {/* Dot grid pattern overlay */}
      <div className="absolute inset-0 bg-grid-pattern opacity-20 pointer-events-none" />

      {/* Floating GradientGlow orbs behind the grid */}
      <GradientGlow
        variant="mixed"
        size="lg"
      ...
      <GradientGlow
        variant="purple"
        size="md"
        className="-left-32 bottom-20 opacity-60"
      />
      <GradientGlow
        variant="cyan"
        size="sm"
        className="right-20 bottom-40 opacity-40"
      />
            ...
            return (
              <motion.div key={category.id} variants={staggerItem}>
                <Card className="h-full flex flex-col">
                  {/* Icon */}
                  <div className="w-14 h-14 rounded-xl bg-gradient-card flex items-center justify-center mb-5 text-cyan">
                  ...
                  <ul className="space-y-2 mb-6 flex-1">
                    {category.services.slice(0, 3).map((service) => (
                      ...
                      >
                        <span className="text-cyan mt-0.5 flex-shrink-0">
                          <svg
